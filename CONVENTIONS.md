...
3. **Code chunks are read aloud.** ≤ ~30 lines, idiomatic but boring Python, no clever one-liners.
   If a chunk needs a comment to be readable, rewrite it until it needs fewer.
